...
def compute_descriptors(mini_traj, trajs, arg, resids_to_atoms, resids_to_noh,
    ...
    get_chunk_info(mini_traj.xyz, resids_to_atoms, resids_to_noh, arg.nb_cut, arg.sb_cut,
                   arg.da_cut, arg.ha_cut, arg.dha_cut, calphas, oxy, nitro,
    ...
    for chunk in chunks:
        ...
        pair_min_dist, pair_cp, pair_nb, pair_sb, pair_hb, pair_int = \
            get_chunk_info(chunk, resids_to_atoms, resids_to_noh, arg.nb_cut, arg.sb_cut,
                           arg.da_cut, arg.ha_cut, arg.dha_cut, calphas, oxy,
                           nitro, donors, hydros, acceptors)
...
@njit(parallel=True)
def get_chunk_info(traj_coords, resids_to_atoms, resids_to_noh, nb_cut, sb_cut, da_cut,
                   ha_cut, dha_cut, calphas, oxy, nitro, donors, hydros,
                   acceptors):
    """
    ...
    for frame in prange(n_frames):
        ...
        pair_min_dists, pair_nb, pair_cp, pair_sb, pair_hb, pair_int = \
            get_frame_info(frame_coords, resids_to_atoms, resids_to_noh, nb_cut, sb_cut,
                           da_cut, ha_cut, dha_cut, calphas, oxy, nitro,
                           donors, hydros, acceptors)
...
@njit(parallel=False)
def get_frame_info(frame_coords, resids_to_atoms, resids_to_noh, nb_cut, sb_cut, da_cut,
                   ha_cut, dha_cut, calphas, oxy, nitro, donors, hydros,
                   acceptors):
    """
    Args:
